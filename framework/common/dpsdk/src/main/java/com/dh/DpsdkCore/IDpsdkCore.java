    ...
    static {
        try {
            switch (NativeLibraryUtil.getArchitecture()) {
                case WINDOWS_32:
                    NativeLoader.loadLibrary("dslalien");
                    NativeLoader.loadLibrary("libdsl");
                    NativeLoader.loadLibrary("PicSDK");
                    NativeLoader.loadLibrary("StreamConvertor");
                    NativeLoader.loadLibrary("PlatformSDK");
                    NativeLoader.loadLibrary("DPSDK_Core");
                    NativeLoader.loadLibrary("DPSDK_Java");
                    break;
                case WINDOWS_64:
                    NativeLoader.loadLibrary("dslalien");
                    NativeLoader.loadLibrary("libdsl");
                    NativeLoader.loadLibrary("PicSDK");
                    NativeLoader.loadLibrary("Infra");
                    NativeLoader.loadLibrary("StreamParser");
                    NativeLoader.loadLibrary("StreamPackage");
                    NativeLoader.loadLibrary("StreamConvertor");
                    NativeLoader.loadLibrary("PlatformSDK");
                    NativeLoader.loadLibrary("DPSDK_Core");
                    NativeLoader.loadLibrary("DPSDK_Java");
